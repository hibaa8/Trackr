...
def get_ashley_system_prompt(coach_summaries: str = ASHLEY_COACH_SUMMARIES) -> str:
    return (
        ...
        "Our coaches:\n"
        f"{coach_summaries}\n"
        "When you have enough info (at least goal + style/experience + 2–3 other basics like age/height/weight "
        "or experience), recommend ONE coach by including exactly this line at the END of your message "
        ...
        "Rules:\n"
        "- Do NOT recommend until you know their goal, experience level, and at least 2–3 other basics.\n"
